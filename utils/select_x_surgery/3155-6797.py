...
if __name__ == '__main__':
    subject_paths = glob('/backup/Breast_cancer_Jiadong/surgical_cohort/3155-4112_4976-5027/*') + glob('/backup/Breast_cancer_Jiadong/surgical_cohort/4113-4975/*') + glob('/backup/Breast_cancer_Jiadong/surgical_cohort/5028-5266/*') + glob('/backup/Breast_cancer_Jiadong/surgical_cohort/5267-5619/*') + glob('/backup/Breast_cancer_Jiadong/surgical_cohort/5620-6797/*')
