...
if __name__ == '__main__':
    subject_paths = glob('/backup/Breast_cancer_Jiadong/surgical_cohort/X_1-2770/MG 742-2770/*')
    print(subject_paths)
    ...
    for subject_path in tqdm(subject_paths):
        ...
        if int(id) > 2172:
            ...
            dcm_3d_paths = glob(os.path.join(subject_path, '**/73400000/*.dcm'), recursive=True) + glob(os.path.join(subject_path, '**/73200000/*.dcm'), recursive=True)
